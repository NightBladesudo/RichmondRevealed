    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <LocationMap items={filteredBusinesses} activeId={activeId} onMarkerClick={handleSelect} />
          <p className="text-xs text-gray-400 mt-2">Click a marker to view business details.</p>
        </div>
      </section>
